...
export function SocialInsightsArea({ current, onSave }: { current?: BrandSocialInsights; onSave: (v: BrandSocialInsights) => Promise<void> }) {
  ...
  return <div className="space-y-5">
    <div><h2 className="text-lg font-bold text-slate-800">Tus redes</h2><p className="mt-1 text-sm leading-5 text-slate-600">Con tus datos reales de cada red, el Planner deja de adivinar: publica a la hora correcta en la red correcta.</p></div>
