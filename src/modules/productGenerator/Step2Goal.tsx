...
const GOALS: GoalDef[] = [
  {
    ...
    tagline: 'Instagram · TikTok · Posts orgánicos',
    desc: 'Imágenes con personalidad y contexto real. Composiciones verticales que detienen el scroll.',
    badge: 'Más popular',
  ...
  },
  {
    ...
    mockMood: 'Premium, cinético, impactante',
