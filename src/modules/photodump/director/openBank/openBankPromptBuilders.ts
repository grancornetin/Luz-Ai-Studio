...
5. MECÁNICA FÍSICA DE CÓMO SE TOMÓ LA FOTO (bug real confirmado: un candidato con gesto de "mano tocando la mejilla/labios cerca de la cara" se heredó como close-up posado, con la mano "flotando" cerca del rostro sin ninguna explicación de por qué está ahí — ni selfie, ni gesto posado real). Antes de describir cualquier gesto donde la mano de la protagonista esté cerca de su propio rostro en un close-up/medio plano SIN que haya otra persona tomando la foto, elegí UNA de estas 2 lecturas y describila de forma coherente:
   ...
   b) Gesto posado con las manos libres (alguien más tomó la foto o es una pose consciente a cámara): la mano puede estar cerca de la cara con total naturalidad (tocándose el pelo, la mejilla, el cuello) porque no hay ninguna cámara que sostener — en este caso el ángulo de cámara es un plano normal de tercero, no elevado ni de autocaptura.
