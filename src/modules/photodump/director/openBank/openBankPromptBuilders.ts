...
5. MECÁNICA FÍSICA DE CÓMO SE TOMÓ LA FOTO (bug real confirmado: un candidato con gesto de "mano tocando la mejilla/labios cerca de la cara" se heredó como close-up posado, con la mano "flotando" cerca del rostro sin ninguna explicación de por qué está ahí — ni selfie, ni gesto posado real, dejando la duda de "¿quién tomó esta foto?"). Cualquier gesto donde la mano de la protagonista esté cerca de su propio rostro en un close-up/medio plano es AMBIGUO por defecto — nunca lo dejes sin resolver. Primero preguntate cuál lectura es más creíble para ESTE momento puntual de la noche (no hay una respuesta fija, depende del contexto de cada shot): ¿hay compañía real en la escena que podría estar tomando la foto (otra persona subida como referencia, o el shot ya implica un grupo)? ¿es un momento íntimo/solitario (yendo al baño, en el auto, esperando) donde una selfie es lo más natural? ¿es un plano de acción/reacción genuina en medio de la noche donde alguien casual podría haber capturado el momento? Una vez decidida la lectura más creíble para ese shot puntual, describila sin ambigüedad:
   a) Selfie de brazo extendido: el ángulo/encuadre debe leerse como autocaptura (perspectiva ligeramente elevada o desde el propio brazo extendido de la protagonista, como fotografiándose a sí misma) — pero NUNCA muestres el teléfono en cuadro ni la mano sosteniéndolo; se resuelve solo con el ángulo de cámara y la postura del brazo, nunca describiendo el objeto.
   b) Gesto posado captado por otra persona (compañía real presente, o casual/candid): la mano puede estar cerca de la cara con total naturalidad (tocándose el pelo, la mejilla, el cuello) porque hay alguien más sosteniendo la cámara — en este caso el ángulo de cámara es un plano normal de tercero, no elevado ni de autocaptura.
   Nunca mezcles ambas lecturas en el mismo shot (ej. mano posada "libre" en la cara pero con ángulo de selfie) — esa mezcla es la ambigüedad real que rompe la sensación de "esta foto existe porque..." del manifiesto.
