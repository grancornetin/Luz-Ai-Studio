...
// ── Render Profile — mirror-selfie / camera-roll (movido desde
// outfitMultiLook/renderProfile.ts, julio 2026) ──────────────────────────
//
// Son reglas globales de la app, no específicas de una receta — validadas
// manualmente durante el diseño de outfit_multi_look
// (ver recipes/manifiesto de direccion/09_session_log_outfit_night_out_validation.md
// y 10_experimental_findings_001.md, Finding 003-005) y confirmadas en
// producción (bugs de fondo de estudio y "clutter", ver
// 12_ESTADO_ACTUAL_retomar_aqui.md). Se movieron acá para que
// outfit_reveal_basic (y cualquier receta futura de mirror-selfie) las use
// sin acoplarse a la carpeta de outfit_multi_look.
