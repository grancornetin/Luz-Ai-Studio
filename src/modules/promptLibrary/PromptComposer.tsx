...
const PromptComposer: React.FC<PromptComposerProps> = ({
  ...
  const handlePublish = (imageUrl: string) => {
    onPublish(imageUrl, safePromptText, dna);
  };
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="group relative">
                    ...
                    <div className="absolute bottom-full left-0 mb-2 w-72 p-2 bg-slate-900 text-white text-[10px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                      Aquí puedes ver y editar las capas del DNA detectadas automáticamente: estilo, persona, producto, iluminación, fondo, composición y detalles. Modificarlas actualiza el prompt automáticamente.
                    </div>
                  </div>
                </div>
              ...
              <div className="flex bg-slate-800/80 p-1.5 rounded-2xl gap-1 flex-shrink-0">
                <div className="relative group flex-1">
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-900 text-white text-[9px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                    Generación única con control total del prompt y DNA.
                  </div>
                </div>
