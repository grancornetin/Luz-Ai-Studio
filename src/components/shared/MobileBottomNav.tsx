    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className={`text-xs font-black uppercase tracking-widest ${isActive('/dashboard') ? 'text-violet-600' : 'text-slate-400'}`}>Inicio</span>
        </button>
        ...
        >
          <PlusSquare size={22} />
          <span className="text-xs font-black uppercase tracking-widest text-slate-400">Crear</span>
        </button>
        ...
        >
          <Search size={22} />
          <span className="text-xs font-black uppercase tracking-widest">Buscar</span>
        </button>
        ...
        <button
          ...
          className={btnClass('/cuenta')}
        >
          <User size={iconSize('/cuenta')} />
          <span className={`text-xs font-black uppercase tracking-widest ${isActive('/cuenta') ? 'text-violet-600' : 'text-slate-400'}`}>Perfil</span>
        </button>
      </nav>
